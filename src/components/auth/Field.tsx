...
/**
 * Campo de formulário com label, ícone, toggle de senha e estados de validação.
 * Componente base para todos os formulários VerticalParts.
 */
    ...
    <div className={cn('mb-4', containerClassName)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          type={inputType}
          className={cn(
            'w-full rounded border bg-white py-3.5 pr-3.5 text-sm text-black outline-none transition',
            ...
            state === 'success' && 'border-green-600 focus:border-green-600 focus:ring-green-600/15',
